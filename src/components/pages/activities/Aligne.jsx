  ...
  return (
    <div>
      ...
      <div className="h-full md:h-[63rem] flex flex-col md:flex-row gap-5 max-md:gap-10 justify-center items-center max-lg:pl-3">
        <img
          src="public/images/activities/L_image_montre_le_portrait_d_une_jeune_femme_africaine_souriante_Elle_a_de_longs_cheveux_noirs_lisses_et_porte_une_chemise_verte_Son_expression_est_joyeuse_et_engageante_avec_un_grand_sourire_radieux_montrant_ses_dents_blanches_Elle_semble_.png"
          alt=""
        ...
        <div className="w-80 md:w-[38rem]">
          ...
          <p className="font-inter font-semibold text-sm sm:text-base lg:text-lg leading-tight text-justify mt-5 md:mt-10 max-md:mb-10">
            ...
            adipisicing elit. Odit id ipsam ducimus maiores iste deleniti, in
            quas deserunt itaque voluptas, architecto ipsum molestias aspernatur{" "}
            <br />
            <br />
            ...
            quam ipsum ad, assumenda dicta vel magnam?Lorem, ipsum dolor sit
            amet consectetur adipisicing elit. Saepe iure dignissimos eos
            quibusdam cumque consequatur assumenda, vero aut fugit dolorum
            quisquam ratione in officia minus, voluptatum illo molestiae
            possimus illum. Lorem ipsum dolor sit amet consectetur adipisicing
            elit. Dicta illo nobis voluptas libero. Cupiditate reiciendis
            itaque, magni voluptate suscipit provident quae quibusdam dolor
            reprehenderit aperiam, nihil optio temporibus quod rem. Lorem ipsum
            dolor, sit amet consectetur adipisicing elit. Odit id ipsam ducimus
            maiores iste deleniti, in quas deserunt itaque voluptas, architecto
            ipsum molestias aspernatur
          </p>
        </div>
      </div>
